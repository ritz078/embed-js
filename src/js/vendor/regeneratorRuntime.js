...
function wrap(innerFn, outerFn, self, tryLocsList) {
    ...
    let generator = Object.create((outerFn || Generator).prototype);
...
regeneratorRuntime.async = function(innerFn, outerFn, self, tryLocsList) {
    ...
    return regeneratorRuntime.isGeneratorFunction(outerFn) ? iter // If outerFn is a generator, return the full iterator.
