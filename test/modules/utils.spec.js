...
describe('Utility functions',function(){
    "use strict";
	it('toUrl() method converts string into a valid url', function () {
	...
	it('truncate() method truncates a string', function(){
	...
	it('getUnique() method returns an array having unique values',function(){
